-- Migration: Require OCC code on patients
...
ALTER TABLE IF EXISTS patients
  ADD COLUMN IF NOT EXISTS occ_code INTEGER REFERENCES medical_personnel_summary(occ_code);

UPDATE patients
SET occ_code = 10
WHERE occ_code IS NULL;

ALTER TABLE IF EXISTS patients
  ALTER COLUMN occ_code SET NOT NULL;
