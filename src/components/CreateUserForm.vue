  ...
  <div class="mt-8">
    ...
    <form @submit.prevent="createUser" class="space-y-4">
      <div>
        ...
        <input id="email" type="email" v-model="email" class="w-full border rounded px-3 py-2" />
      </div>
      <div>
        <label class="block text-sm font-medium mb-1" for="password">Password</label>
        <input id="password" type="password" v-model="password" class="w-full border rounded px-3 py-2" />
      </div>
      <div>
        <label class="block text-sm font-medium mb-1" for="confirmPasswordUser">Confirm Password</label>
        <input id="confirmPasswordUser" type="password" v-model="confirmPassword" class="w-full border rounded px-3 py-2" />
      </div>
